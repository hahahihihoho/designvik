		...
		<div class="row">
			<div class="col-md-12 panel panel-default">
				<div class="panel-body">
			        ...
			        <form action="" method="post" role="form" class="bg-white pad1p">
			                    ...
			                    <div class="form-group">
			                    	<div class="col-sm-6">
				                        <div class="form-group label-floating">
										  ...
										  <input class="form-control" id="judul" type="text" required>
										</div>
			                        </div>
			                    	...
			                    	<div class="col-sm-6">
				                        <div class="form-group label-floating">
										  ...
										  <input class="form-control" id="tujuan" type="text" required>
										</div>
			                        </div>
			                    </div>
			                    ...
			                    <div class="form-group">
			                    	<div class="col-sm-6">
				                        <div class="form-group label-floating">
										  ...
										  <input class="form-control" id="datefrom" type="text" required>
										</div>
			                        </div>
			                    	...
			                    	<div class="col-sm-6">
				                        <div class="form-group label-floating">
										  ...
										  <input class="form-control" id="dateto" type="text" required>
										</div>
			                        </div>
			                    </div>
			                    ...
			                    <div class="form-group">
			                    	<div class="col-sm-6">
				                        <div class="form-group label-floating">
										  ...
										  <input class="form-control" id="meetpoint" type="text" required>
										</div>
			                        </div>
			                    ...
			                    <div class="form-group">
			                    	<div class="col-sm-6">
			                    		<div class="form-group label-floating">
					                        ...
					                        <input class="form-control" id="prices" min="10000" required="required" type="text">
					                    </div>
			                        </div>
			                    	...
			                    	<div class="col-sm-12">
			                    		<div class="form-group label-floating">
					                        ...
					                        <textarea class="form-control" maxlength="100" id="includes"></textarea>
				                        </div>
			                        </div>
			                        ...
			                        <div class="col-sm-12">
			                        	<div class="form-group label-floating">
					                        ...
					                        <textarea class="form-control" maxlength="100" id="notincludes"></textarea>
				                        </div>
			                        </div>
			                        ...
			                        <div class="col-sm-12">
			                        	<div class="form-group label-floating">
					                        ...
					                        <textarea class="form-control" maxlength="100" id="terms"></textarea>
				                        </div>
			                        </div>
			                    </div>
			                </div>
			            ...
			            <div class="row setup-content form-content" id="step-4">
		                    ...
		                    <div class="col-md-12">
		                        ...
		                        <button class="btn btn-raised btn-warning nextBtn btn-lg pull-right" type="submit" id="createtrip">Next</button>
		                    </div>
